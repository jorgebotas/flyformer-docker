...
from flyformer import FlyformerPretrainer
...
MODEL_PARAMETERS = {
    ...
    # Flyformer uses Relu, but should try Gelu (avoids "dead neurons")
...
model.train()
# Build Flyformer pretrainer
pretrainer = FlyformerPretrainer(
    model=model,
